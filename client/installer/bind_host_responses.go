...
// NewBindHostAccepted creates a BindHostAccepted with default headers values
func NewBindHostAccepted() *BindHostAccepted {
	return &BindHostAccepted{}
}

/*BindHostAccepted handles this case with default header values.
...
func (o *BindHostAccepted) Error() string {
	return fmt.Sprintf("[POST /clusters/{cluster_id}/hosts/{host_id}/actions/bind][%d] bindHostAccepted  %+v", 202, o.Payload)
}

func (o *BindHostAccepted) GetPayload() *models.Host {
	return o.Payload
}

func (o *BindHostAccepted) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *BindHostUnauthorized) Error() string {
	return fmt.Sprintf("[POST /clusters/{cluster_id}/hosts/{host_id}/actions/bind][%d] bindHostUnauthorized  %+v", 401, o.Payload)
}
...
func (o *BindHostForbidden) Error() string {
	return fmt.Sprintf("[POST /clusters/{cluster_id}/hosts/{host_id}/actions/bind][%d] bindHostForbidden  %+v", 403, o.Payload)
}
...
func (o *BindHostNotFound) Error() string {
	return fmt.Sprintf("[POST /clusters/{cluster_id}/hosts/{host_id}/actions/bind][%d] bindHostNotFound  %+v", 404, o.Payload)
}
...
// NewBindHostConflict creates a BindHostConflict with default headers values
func NewBindHostConflict() *BindHostConflict {
	return &BindHostConflict{}
}

/*BindHostConflict handles this case with default header values.
...
func (o *BindHostConflict) Error() string {
	return fmt.Sprintf("[POST /clusters/{cluster_id}/hosts/{host_id}/actions/bind][%d] bindHostConflict  %+v", 409, o.Payload)
}

func (o *BindHostConflict) GetPayload() *models.Error {
	return o.Payload
}

func (o *BindHostConflict) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *BindHostInternalServerError) Error() string {
	return fmt.Sprintf("[POST /clusters/{cluster_id}/hosts/{host_id}/actions/bind][%d] bindHostInternalServerError  %+v", 500, o.Payload)
}
